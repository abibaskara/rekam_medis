        ...
        <div class="page-title-box">
            <div class="btn-group float-right">
                <ol class="breadcrumb hide-phone p-0 m-0">
                    ...
                    <li class="breadcrumb-item active">Tambah Data Medical Check Up</li>
                </ol>
            </div>
            <h4 class="page-title">Tambah Data Medical Check Up</h4>
        </div>
    </div>
</div>
    ...
    <div class="col-lg-12">
        <div class="row">
            <div class="col-md-12 col-lg-12 col-xl-12">
                <div class="card">
                    <div class="card-body">
                        <h4 style="text-align: center;">Tambah Data Medical Check Up</h4>
                        <hr>
                        <form action="<?= base_url(); ?>Admin/tambahMedicalCheckUp" method="POST">
                            <div class="row">
                                ...
                                <div class="col-12 mt-2">
                                    ...
                                    <input type="text" class="form-control" name="fasilitator_mcu" placeholder="Fasilitator MCU" required autocomplete="off" />
                                </div>

                                <div class="col-12 mt-2">
                                    <h6 class="input-title mt-0">Waktu MCU <span style="color: red;">*</span></h6>
                                    <input type="text" class="form-control" name="waktu_mcu" id="waktu_mcu" placeholder="Waktu MCU" required autocomplete="off" />
                                </div>

                                <div class="col-12 mt-2">
                                    <h6 class="input-title mt-0">Tekanan Darah <span style="color: red;">*</span></h6>
                                    <input type="text" name="tekanan_darah" class="form-control" placeholder="Tekanan Darah" required autocomplete="off">
                                </div>

                                <div class="col-12 mt-2">
                                    <h6 class="input-title mt-0">Hasil Pemeriksaan Oleh Dokter Umum <span style="color: red;">*</span></h6>
                                    <textarea name="hasil_pemeriksaan_dokter" class="form-control" cols="30" rows="10"></textarea>
                                </div>

                                <div class="col-12 mt-2">
                                    <h6 class="input-title mt-0">Hasil Lab Urin <span style="color: red;">*</span></h6>
                                    <input type="text" name="hasil_lab_urin" class="form-control" placeholder="Hasil Lab Urin" required autocomplete="off">
                                </div>

                                <div class="col-12 mt-2">
                                    <h6 class="input-title mt-0">Hasil Rontgen Thorak <span style="color: red;">*</span></h6>
                                    <input type="text" name="hasil_rontgen_thorak" class="form-control" placeholder="Hasil Rontgen Thorak" required autocomplete="off">
                                </div>

                                <div class="col-12 mt-2">
                                    <h6 class="input-title mt-0">Hasil Pemeriksaan Mata Rabun Jauh dan Dekat <span style="color: red;">*</span></h6>
                                    <input type="text" name="hasil_pemeriksaan_mata" class="form-control" placeholder="Hasil Pemeriksaan Mata Rabun Jauh dan Dekat" required autocomplete="off">
                                </div>

                                <div class="col-12 mt-2">
                                    <h6 class="input-title mt-0">Hasil Pemeriksaan Audiometri (Fungsi Pendengaran) <span style="color: red;">*</span></h6>
                                    <input type="text" name="hasil_pemeriksaan_pendengaran" class="form-control" placeholder="Hasil Pemeriksaan Audiometri" required autocomplete="off">
                                </div>
