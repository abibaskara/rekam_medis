            ...
            <div class="col-md-12 col-lg-12 col-xl-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <hr>
                        <form action="<?= base_url(); ?>Admin/editSuratKeteranganDokter" method="POST">
                            <div class="row">
                                <div class="col-12 mt-2">
                                    ...
                                    <select class="form-control mb-3" id="nik" name="id_karyawan" style="width: 100%; height:36px;" onchange="show_karyawan(this.value)" required>
                                        ...
                                        <?php foreach ($data_karyawan as $row) { ?>
                                            <option value=" <?= $row->id_karyawan ?>" <?= $skd['id_karyawan'] == $row->id_karyawan ? 'selected' : '' ?>><?= $row->nik ?> || <?= $row->nama_karyawan ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                                ...
                                <div class="col-12 mt-2">
                                    ...
                                    <input type="hidden" value="<?= $skd['id_skd'] ?>" name="id_skd">
                                    <input type="text" name="nama_karyawan" id="nama_karyawan" class="form-control" value="<?= $skd['nama_karyawan'] ?>" readonly required>
                                </div>
                                ...
                                <div class="col-12 mt-2">
                                    ...
                                    <input type="text" class="form-control" name="tgl_mulai" id="tgl_mulai" value="<?= $skd['tanggal_mulai_skd'] ?>" placeholder="Tanggal Mulai" required autocomplete="off" />
                                </div>

                                <div class="col-12 mt-2">
                                    <h6 class="input-title mt-0">Tanggal Akhir <span style="color: red;">*</span></h6>
                                    <input type="text" class="form-control" name="tgl_akhir" id="tgl_akhir" value="<?= $skd['tanggal_akhir_skd'] ?>" placeholder="Tanggal Akhir" required autocomplete="off" />
                                </div>

                                <div class="col-12 mt-2">
                                    <h6 class="input-title mt-0">Diagnosa Penyakit <span style="color: red;">*</span></h6>
                                    <input type="text" name="diagnosa_penyakit" class="form-control" value="<?= $skd['diagnosa_penyakit'] ?>" placeholder="Diagnosa Penyakit" required autocomplete="off">
                                </div>

                                <div class="col-12 mt-2">
                                    <h6 class="input-title mt-0">Tempat Berobat <span style="color: red;">*</span></h6>
                                    <textarea name="tempat_berobat" class="form-control" cols="30" rows="10"><?= $skd['tempat_berobat'] ?></textarea>
                                </div>
