        ...
        <div class="page-title-box">
            <div class="btn-group float-right">
                <ol class="breadcrumb hide-phone p-0 m-0">
                    ...
                    <li class="breadcrumb-item active">Laporan Medical Check Up</li>
                </ol>
            </div>
            <h4 class="page-title">Laporan Medical Check Up</h4>
        </div>
    </div>
</div>
    ...
    <div class="col-lg-12">
        <div class="row">
            <div class="col-md-12 col-lg-12 col-xl-12">
                <div class="card">
                    <div class="card-body">
                        <h4 style="text-align: center;">Laporan Medical Check Up</h4>
                        <hr>
                        <div class="row">
                    ...
                    <div class="card-body">
                        <div id="doc_print">
                            <div class="row">
                                ...
                                <div class="col-12 mt-4" id="tampil_preview_mcu">
                                </div>
                            </div>
                        </div>
                    </div>
...
<script>
    $(document).ready(function() {
        ...
        var tampil_preview_mcu = document.getElementById("tampil_preview_mcu")
        tampil_preview_mcu.style.display = "none"
        ...
        $("#preview").click(function() {
            tampil_preview_mcu.style.display = "block"
    ...
    function show_preview(id_karyawan, tgl_awal, tgl_akhir) {
        ...
        $.ajax({
            url: "<?php echo base_url('Ho/get_laporan_rekam_medis'); ?>",
            type: "GET",
            dataType: "JSON",
            data: {
            ...
            success: function(value) {
                ...
                $('#tampil_preview_mcu').html(`
                            ...
                            <th style='text-align: center;'>HASIL PEMERIKSAAN DOKTER</th>
                            <th style='text-align: center;'>HASIL LAB URIN</th>
                            <th style='text-align: center;'>HASIL RONTGEN THORAK</th>
                            <th style='text-align: center;'>HASIL PEMERIKSAAN MATA</th>
                            <th style='text-align: center;'>HASIL PEMERIKSAAN PENDENGARAN</th>
                            </tr>
                            </thead>
                            <tbody id='preview_mcu'>
                            </tbody>
                            </table>
                            `);

                $.each(value.mcu, function(k, v) {
                    var body = `
                                <tr> 
    ...
    function show_header(id_karyawan) {
        $.ajax({
            url: "<?php echo base_url('Ho/get_header_print'); ?>",
            type: "GET",
            dataType: "JSON",
            data: {
                id_karyawan: id_karyawan,
