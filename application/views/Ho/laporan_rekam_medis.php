...
<div class="row">
    <div class="col-sm-12">
        <div class="page-title-box">
            ...
            <h4 class="page-title">Laporan Rekam Medis</h4>
        </div>
    </div>
</div>
    ...
    <div class="col-lg-12">
        <div class="row">
            <div class="col-md-12 col-lg-12 col-xl-12">
                <div class="card">
                    <div class="card-body">
                        <h4 style="text-align: center;">Laporan Rekam Medis</h4>
                        <hr>
                        <div class="row">
                    ...
                    <div class="card-body">
                        <div id="doc_print">
                            <div class="row">
                                ...
                                <div class="col-12 mt-4" id="tampil_preview_skd">
                                </div>
...
<script>
    $(document).ready(function() {
        ...
        var tampil_preview_skd = document.getElementById("tampil_preview_skd")
        tampil_preview_skd.style.display = "none"
        ...
        $("#preview").click(function() {
            ...
            tampil_preview_skd.style.display = "block"
        ...
        $.ajax({
            ...
            success: function(value) {
                ...
                $('#tampil_preview_skd').html(`
                            ...
                            <tbody id='preview_skd'>
                            </tbody>
                            </table>
                            `);
                $.each(value.skd, function(k, v) {
                    var body = `
                                <tr> 
                ...
                $('#tampil_preview_mcu').html(`
                            ...
                            <th scope='col' style='text-align: center;'>NIK</th>
                            <th scope='col' style='text-align: center;'>NAMA</th>
                            <th scope='col' style='text-align: center;'>FASILITATOR</th>
